...
export const inputPosition = formEdit.querySelector(
  ".form__input_value_position"
);
...
export const popupAvatarSubmit = popupAvatar.querySelector(
  ".form__submit-button"
);
export const popupConfirmSubmit = popupConfirm.querySelector(
  ".form__submit-button"
);
